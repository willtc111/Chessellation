export class Chessellator {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(Chessellator.prototype);
        obj.__wbg_ptr = ptr;
        ChessellatorFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        ChessellatorFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_chessellator_free(ptr, 0);
    }
    /**
     * @returns {Int32Array}
     */
    flush_changes() {
        const ret = wasm.chessellator_flush_changes(this.__wbg_ptr);
     ...
     * @returns {Chessellator}
     */
    static new(inputs_json) {
        const ptr0 = passStringToWasm0(inputs_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.chessellator_new(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Chessellator.__wrap(ret[0]);
    }
    step() {
        wasm.chessellator_step(this.__wbg_ptr);
    }
}
...
const ChessellatorFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_chessellator_free(ptr >>> 0, 1));
